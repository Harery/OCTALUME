...
- **Developers** - Understanding framework file organization
- **DevOps Engineers** - Configuring OCTALUME in environments
- **Technical Leads** - Evaluating framework structure
- **System Administrators** - Managing OCTALUME deployments

## Table of Contents

1. [Root Directory](#root-directory)
2. [.claude/ Directory](#claude-directory)
3. [skills/ Directory](#skills-directory)
4. [File Descriptions](#file-descriptions)
5. [Traceability Naming Convention](#traceability-naming-convention)
...
├── TESTING_GUIDE.md               # Testing guide for fresh installations
├── FRAMEWORK_VISUALIZATION.md     # Mermaid diagrams showing workflows
...
│   └── phase-gate-validator.js    # Phase gate validation
│
├── escalation/                    # Go/no-go enforcement
│   └── escalation-manager.js      # Escalation and decisions
│
├── bindings/                      # Task-skill binding
│   └── task-skill-binder.js       # Binds tasks to skills
│
├── handoff/                       # Phase handoff verification
│   └── handoff-verify.js          # Phase transition verification
│
├── memory/                        # Memory management system
│   ├── memory-lock.js             # File-based locking
│   ├── state-sync.js              # Bidirectional synchronization
...
| File | Description |
|------|-------------|
| `SETUP_GUIDE.md` | Complete guide to set up and use Claude Code |
| `TESTING_GUIDE.md` | Guide for testing OCTALUME on fresh Linux installation |
