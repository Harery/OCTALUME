...
- **Tools**: SonarQube (most popular), Semgrep (fast, customizable), Checkmarx (enterprise), Veracode
- Scans source code for vulnerabilities
- Integrated into CI/CD pipeline
- Runs on every commit
- **2025 Recommendation**: SonarQube (free community edition) or Semgrep

### Dynamic Application Security Testing (DAST)
- **Tools**: OWASP ZAP (free, community), Burp Suite (professional)
- Tests running application
- Identifies runtime vulnerabilities
- Integrated into testing phase
- **2025 Recommendation**: OWASP ZAP for free, Burp Suite for enterprise

### Software Composition Analysis (SCA)
- **Tools**: Snyk (best DX, integrates well), Dependabot (GitHub native), WhiteSource (enterprise)
- Scans dependencies for vulnerabilities
- Checks license compliance
- Integrated into CI/CD pipeline
- **2025 Recommendation**: Snyk or Dependabot for most projects

### Container Security
- **Tools**: Trivy (free, comprehensive), Clair (open source), Aqua (enterprise)
- Scans container images for vulnerabilities
- Checks for security issues in Docker images
- **2025 Recommendation**: Trivy (free, excellent coverage)
...
## SECURITY TOOLS (2025-2026 Recommendations)

| Category | Recommended Tools | Alternatives |
|----------|-------------------|--------------|
| **SAST** | SonarQube, Semgrep | Fortify, Checkmarx, Veracode |
| **DAST** | OWASP ZAP | Burp Suite |
| **SCA** | Snyk, Dependabot | WhiteSource, Black Duck |
| **Container Security** | Trivy | Clair, Aqua |
| **IaC Security** | Checkov, tfsec | tflint, OPA |
| **WAF** | CloudFlare, AWS WAF | ModSecurity |
| **SIEM** | Splunk, ELK | Sumo Logic, Datadog |
| **Secrets Management** | HashiCorp Vault, AWS Secrets Manager | Azure Key Vault |
| **Auth Providers** | Auth0, Supabase Auth | Firebase Auth, Clerk, NextAuth |
